...
function sortDate(){
	...
	for (var i = 0; i < flights.length; i++) {
		...
		document.querySelector('.launch-list ul').innerHTML+=
		"<li class="+(i)+">#"+ flights[i].flight_number + ' ' +flights[i].mission_name+' '+ '<span>('+ fname[0] + ')</span>'+"</li>"
	}
...
function sortName(){
	var first = (flights[0].flight_number)
	var sortName;
	...
	for (var i = (sortName.length-1); i >= 0; i--) {
		...
		var flightfix= []
		document.querySelector('.launch-list ul').innerHTML+=
		"<li class="+(flight_number(sortName[i].flight_number))+">"+sortName[i].mission_name+ ' #'+ sortName[i].flight_number + ' '+ '<span>('+ fname[0] + ')</span>'+"</li>"
	}
}
function sortNameRev(){
	...
	for (var i = 0; i < sortNameRev.length; i++) {
		...
		document.querySelector('.launch-list ul').innerHTML+=
		"<li class="+(flight_number(sortNameRev[i].flight_number))+">"+sortNameRev[i].mission_name+ ' #'+ sortNameRev[i].flight_number + ' '+ '<span>('+ fname[0] + ')</span>'+"</li>"
	}
}


function flight_number(flightnumber){
